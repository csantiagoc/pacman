...
public class ConnectedSet implements Drawable {
    ...
    public boolean isBlinky() {
        validate();
        return fg == MsPacInterface.blinky && width >= 10 && height >= 10;

    }

    public boolean isPinky() {
        validate();
        return fg == MsPacInterface.pinky && width >= 10 && height >= 10;

    }

    public boolean isInky() {
        validate();
        return fg == MsPacInterface.inky && width >= 10 && height >= 10;

    }

    public boolean isSue() {
        validate();
        return fg == MsPacInterface.sue && width >= 10 && height >= 10;
